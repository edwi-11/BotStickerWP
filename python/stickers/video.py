...
def _probe(src: Path) -> dict:
    try:
        ...
        raise VideoError("Video invalido o ilegible") from e
...
def convert_video(src: Path, out: Path) -> None:
    ...
    if info["dur"] > MAX_SRC_SECONDS:
        raise VideoError(f"El video dura mas de {MAX_SRC_SECONDS} segundos")
    ...
    for fps, q, secs in ((15, 55, 6), (12, 45, 6), (10, 35, 5), (8, 25, 4), (6, 15, 3)):
        ...
        try:
            ...
            raise VideoError("FFmpeg no pudo convertir el video") from e
